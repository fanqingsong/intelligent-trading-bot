...
from shared import ALL_STEPS, get_config_path, get_redis_url
...
def get_step_runner(step: str) -> Callable[[str], None]:
    mapping = {
        "download": ("pipeline.steps.download", "run_download"),
        "merge": ("pipeline.steps.merge", "run_merge"),
        "features": ("pipeline.steps.features", "run_features"),
        "labels": ("pipeline.steps.labels", "run_labels"),
        "train": ("pipeline.steps.train", "run_train"),
        "predict": ("pipeline.steps.predict", "run_predict"),
        "signals": ("pipeline.steps.signals", "run_signals"),
        "output": ("pipeline.steps.output", "run_output"),
        "predict_rolling": ("pipeline.steps.predict_rolling", "run_predict_rolling"),
        "simulate": ("pipeline.steps.simulate", "run_simulate"),
    }
